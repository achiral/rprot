...
GENE <- Hmisc::llist(gene_p, gene_c, gene_pc)
...
setwd("./p")
if(!dir.exists("05_go")){dir.create("05_go")}
setwd("./05_go")
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("06_kegg")){dir.create("06_kegg")}
setwd("./06_kegg")
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("07_wiki")){dir.create("07_wiki")}
setwd("./07_wiki")
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("08_reactome")){dir.create("08_reactome")}
setwd("./08_reactome")
getwd()
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("09_disease")){dir.create("09_disease")}
setwd("./09_disease")
getwd()
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("10_mesh")){dir.create("10_mesh")}
setwd("./10_mesh")
getwd()
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("10_cellmarker")){dir.create("10_cellmarker")}
setwd("./10_cellmarker")
getwd()
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("11_msigdb")){dir.create("11_msigdb")}
setwd("./11_msigdb")
getwd()
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("12_multilist")){dir.create("12_multilist")}
setwd("./12_multilist")
getwd()
...
setwd(DIR_HOST)        # move to host working directory
################################################################################
## 13. functional profile comparison #####
################################################################################
## file save directory #####
## make directory to save images of enrichment analysis
setwd(DIR_HOST)        # move to host working directory
...
if(!dir.exists("p")){dir.create("p")}
setwd("./p")
if(!dir.exists("13_functionprofile")){dir.create("13_functionprofile")}
setwd("./13_functionprofile")
getwd()
