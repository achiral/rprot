...
# DATA_FOLDER <- 20211006
# DATA_FOLDER <- 20211016
# DATA_FOLDER <- 20211022
...
## DATA_FOLDER <- 20211006
# df1 <- shock_data(df = df, file_no = 1, shock_time = 174.07)
# df2 <- shock_data(df = df, file_no = 2, shock_time = 123.89)
# df3 <- shock_data(df = df, file_no = 3, shock_time = 300.09)
# df4 <- shock_data(df = df, file_no = 4, shock_time = 196.76)
## DATA_FOLDER <- 20211016
# df1 <- shock_data(df = df, file_no = 1, shock_time = 138.57)
## DATA_FOLDER <- 20211022
# df1 <- shock_data(df = df, file_no = 1, shock_time = 128.07)
...
# colnames(out) <- c("Time", "aPCPaCLZ01", "aPCPaCLZ02", "aPCPaCLZ03", "aPCPaCLZ04")
# colnames(out) <- c("Time", "aPCPaHAL01")
# colnames(out) <- c("Time", "aPCPaRIS01")
## output xlsx
