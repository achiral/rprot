...
#抽出文字結合
sdata2 <- cbind(sdata2, Protein.IDs, Gene.names, Species) #sdata2, Protein.IDs, Gene.names, Speciesを列ベクトル単位で結合 
...
sheets2 <- list("Pq005"=twANOVA_Pq005[,grep("(rownames.sdata.|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Gene.names|Species|Group)", colnames(twANOVA_Pq005))],
                "Cq005"=twANOVA_Cq005[,grep("(rownames.sdata.|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Gene.names|Species|Group)", colnames(twANOVA_Cq005))],
                "PxCq005"=twANOVA_PxCq005[,grep("(rownames.sdata.|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Gene.names|Species|Group)", colnames(twANOVA_PxCq005))])
