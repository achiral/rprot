...
data2 <- read_excel("Stat.xlsx", sheet = 2) #シート2の読み込み
data3 <- read_excel("Stat.xlsx", sheet = 3) #シート3の読み込み
data4 <- read_excel("Stat.xlsx", sheet = 4) #シート4の読み込み
data5 <- read_excel("Stat.xlsx", sheet = 5) #シート5の読み込み
...
#filter#############################################################
#protein coding
data1m <- data1 %>% filter(type_of_gene == "protein-coding") %>%
  filter(p < 0.05)
data2m <- data2 %>% filter(type_of_gene == "protein-coding") %>%
  filter(p < 0.05)
data3m <- data3 %>% filter(type_of_gene == "protein-coding") %>%
  filter(p < 0.05)
data4m <- data4 %>% filter(type_of_gene == "protein-coding") %>%
  filter(p < 0.05)
data5m <- data5 %>% filter(type_of_gene == "protein-coding") %>%
  filter(p < 0.05)
#ggplot2#############################################################
