...
plot_set(ek, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_ek_p.svg",            # filegp  = "gp.svg"
         filebp       = "bp_ek_p.svg",            # filebp  = "bp.svg"
         filedp       = "dp_ek_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_ek_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_ek_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_ek_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_ek_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_ek_p.svg")            # filecp  = "cp.svg"

plot_set(ek2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_ek2_p.svg",           # filegp  = "gp.svg"
         filebp       = "bp_ek2_p.svg",           # filebp  = "bp.svg"
         filedp       = "dp_ek2_p.svg",           # filedp  = "dp.svg"
         filehp       = "hp_ek2_p.svg",           # filehp  = "hp.svg"
         filetp       = "tp_ek2_p.svg",           # filetp  = "tp.svg"
         filemp       = "mp_ek2_p.svg",           # filemp  = "mp.svg"
         fileusp      = "usp_ek2_p.svg",          # fileusp = "usp.svg"
         filecp       = "cp_ek2_p.svg")           # filecp  = "cp.svg"

plot_set(ek3,
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_ek3_p.svg",           # filegp  = "gp.svg"
         filebp       = "bp_ek3_p.svg",           # filebp  = "bp.svg"
         filedp       = "dp_ek3_p.svg",           # filedp  = "dp.svg"
         filehp       = "hp_ek3_p.svg",           # filehp  = "hp.svg"
         filetp       = "tp_ek3_p.svg",           # filetp  = "tp.svg"
         filemp       = "mp_ek3_p.svg",           # filemp  = "mp.svg"
         fileusp      = "usp_ek3_p.svg",          # fileusp = "usp.svg"
         filecp       = "cp_ek3_p.svg")           # filecp  = "cp.svg"

plot_set(mek, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_mek_p.svg",            # filegp  = "gp.svg"
         filebp       = "bp_mek_p.svg",            # filebp  = "bp.svg"
         filedp       = "dp_mek_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_mek_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_mek_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_mek_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_mek_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_mek_p.svg")            # filecp  = "cp.svg"

plot_set(mek2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_mek2_p.svg",           # filegp  = "gp.svg"
         filebp       = "bp_mek2_p.svg",           # filebp  = "bp.svg"
         filedp       = "dp_mek2_p.svg",           # filedp  = "dp.svg"
         filehp       = "hp_mek2_p.svg",           # filehp  = "hp.svg"
         filetp       = "tp_mek2_p.svg",           # filetp  = "tp.svg"
         filemp       = "mp_mek2_p.svg",           # filemp  = "mp.svg"
         fileusp      = "usp_mek2_p.svg",          # fileusp = "usp.svg"
         filecp       = "cp_mek2_p.svg")           # filecp  = "cp.svg"

plot_set(mek3,
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_mek3_p.svg",           # filegp  = "gp.svg"
         filebp       = "bp_mek3_p.svg",           # filebp  = "bp.svg"
         filedp       = "dp_mek3_p.svg",           # filedp  = "dp.svg"
         filehp       = "hp_mek3_p.svg",           # filehp  = "hp.svg"
         filetp       = "tp_mek3_p.svg",           # filetp  = "tp.svg"
         filemp       = "mp_mek3_p.svg",           # filemp  = "mp.svg"
         fileusp      = "usp_mek3_p.svg",          # fileusp = "usp.svg"
...
plot_set(er, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_er_p.svg",            # filegp  = "gp.svg"
...
plot_set(emesh2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emesh_p.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emesh_p.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emesh_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emesh_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emesh_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emesh_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emesh_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emesh_p.svg")            # filecp  = "cp.svg"
...
plot_set(ecm2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_ecm_p.svg",            # filegp  = "gp.svg"
         filebp       = "bp_ecm_p.svg",            # filebp  = "bp.svg"
         filedp       = "dp_ecm_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_ecm_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_ecm_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_ecm_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_ecm_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_ecm_p.svg")            # filecp  = "cp.svg"
...
plot_set(emsig_H_2, 
         ...
         filedp       = "dp_emsig_H_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_H_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_H_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_H_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_H_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_H_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C1_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C1.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C1.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C1_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C1_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C1_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C1_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C1_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C1_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C2_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C2.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C2.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C2_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C2_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C2_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C2_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C2_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C2_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C3_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C3.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C3.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C3_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C3_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C3_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C3_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C3_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C3_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C4_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C4.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C4.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C4_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C4_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C4_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C4_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C4_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C4_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C5_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C5.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C5.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C5_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C5_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C5_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C5_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C5_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C5_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C6_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C6.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C6.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C6_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C6_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C6_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C6_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C6_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C6_p.svg")            # filecp  = "cp.svg"

plot_set(emsig_C7_2, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_emsig_C7.svg",            # filegp  = "gp.svg"
         filebp       = "bp_emsig_C7.svg",            # filebp  = "bp.svg"
         filedp       = "dp_emsig_C7_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_emsig_C7_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_emsig_C7_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_emsig_C7_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_emsig_C7_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_emsig_C7_p.svg")            # filecp  = "cp.svg"
...
plot_set(ck, 
         ...
         filedp       = "dp_ck_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_ck_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_ck_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_ck_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_ck_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_ck_p.svg")            # filecp  = "cp.svg"

plot_set(cr, 
         showCategory = showCategory,             # modify showCategory
         filegp       = "gp_cr.svg",            # filegp  = "gp.svg"
         filebp       = "bp_cr.svg",            # filebp  = "bp.svg"
         filedp       = "dp_cr_p.svg",            # filedp  = "dp.svg"
         filehp       = "hp_cr_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_cr_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_cr_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_cr_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_cr_p.svg")            # filecp  = "cp.svg"
...
plot_set(fr, 
         ...
         filedp       = "dp_fr_p.svg",            # filedp  = "dp.svg"
         filedp2      = "dp2_fr_p.svg",           # filedp2  = "dp2.svg"
         filehp       = "hp_fr_p.svg",            # filehp  = "hp.svg"
         filetp       = "tp_fr_p.svg",            # filetp  = "tp.svg"
         filemp       = "mp_fr_p.svg",            # filemp  = "mp.svg"
         fileusp      = "usp_fr_p.svg",           # fileusp = "usp.svg"
         filecp       = "cp_fr_p.svg")            # filecp  = "cp.svg"
