...
ls2 <- grep("P68134|P68368|P05213|P60710|Q7TMM9|Q9ERD7|Q9D6F9|P99024|Q921l1|P18760|P19783|P16858|O09106|P68433|P63038|P14733|P14094|Q8VDN2|Q9WV27|P17918|P29037|Q60932|Q64727|Q00899",anno$Protein.IDs)
anno2 <- anno[ls1,]
anno3 <- anno[ls2,]
...
LC_prc_mean <- LC_prc[,grep("^Protein|GeneName|mean$",colnames(LC_prc))] #mean値抽出
LC_prc_mean <- LC_prc_mean %>% filter(!is.na(SC0_mean)) #NA値除去
LC_prc_THSDp <- LC_prc[,grep("^Protein|GeneName|^THSDp",colnames(LC_prc))] #THSDp値抽出
...
LC_prc_mean <- mean_table(LC_prc_mean) #output
...
write_xlsx(LC_prc_THSDp, "LC_prc_THSDp.xlsx", format_headers = FALSE)
################################################################################
...
twANOVA_Cq005 <- sdata3 %>% filter(Species == "MOUSE") %>% filter(q_C < 0.05)
twANOVA_PxCq005 <- sdata3 %>% filter(Species == "MOUSE") %>% filter(q_PxC < 0.05)
ls_DEPtwANOVA_Pq005[[1]] <- as.data.frame(twANOVA_Pq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Pq005))]) #統計値はすべて同じのためj=1のみ出力
ls_DEPtwANOVA_Cq005[[1]] <- as.data.frame(twANOVA_Cq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Cq005))]) #統計値はすべて同じのためj=1のみ出力
ls_DEPtwANOVA_PxCq005[[1]] <- as.data.frame(twANOVA_PxCq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_PxCq005))]) #統計値はすべて同じのためj=1のみ出力
#ls_DEPtwANOVA_Pq005[[j]] <- as.data.frame(twANOVA_Pq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Pq005))]) #統計値はすべて同じのためj=1のみ出力
#ls_DEPtwANOVA_Cq005[[j]] <- as.data.frame(twANOVA_Cq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Cq005))]) #統計値はすべて同じのためj=1のみ出力
#ls_DEPtwANOVA_PxCq005[[j]] <- as.data.frame(twANOVA_PxCq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_PxCq005))]) #統計値はすべて同じのためj=1のみ出力
}
...
for(k in 1:nrow(LC_prc_mean)){
  ...
  twANOVA_Cq005 <- sdata3 %>% filter(Species == "MOUSE") %>% filter(q_C < 0.05)
  twANOVA_PxCq005 <- sdata3 %>% filter(Species == "MOUSE") %>% filter(q_PxC < 0.05)
  ls_DEPtwANOVA_Pq005_all[[1]] <- as.data.frame(twANOVA_Pq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Pq005))]) #統計値はすべて同じのためk=1のみ出力
  ls_DEPtwANOVA_Cq005_all[[1]] <- as.data.frame(twANOVA_Cq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Cq005))]) #統計値はすべて同じのためk=1のみ出力
  ls_DEPtwANOVA_PxCq005_all[[1]] <- as.data.frame(twANOVA_PxCq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_PxCq005))]) #統計値はすべて同じのためk=1のみ出力
  #ls_DEPtwANOVA_Pq005_all[[k]] <- as.data.frame(twANOVA_Pq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Pq005))]) #統計値はすべて同じのためk=1のみ出力
  #ls_DEPtwANOVA_Cq005_all[[k]] <- as.data.frame(twANOVA_Cq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_Cq005))]) #統計値はすべて同じのためk=1のみ出力
  #ls_DEPtwANOVA_PxCq005_all[[k]] <- as.data.frame(twANOVA_PxCq005[,grep("(GeneName|p_P$|p_C$|p_PxC$|q_P$|q_C$|q_PxC$|Protein.IDs|Description|GN)", colnames(twANOVA_PxCq005))]) #統計値はすべて同じのためk=1のみ出力
}
